...
Without limiting the generality of the foregoing, all rights are reserved with respect to:

- copying and redistribution;
- commercial and non-commercial use;
- modification and derivative works;
- publication and sublicensing;
- training or evaluating machine learning systems on repository contents;
- extraction or reuse of code structure, specifications, documentation, icons, artwork, or branding.
